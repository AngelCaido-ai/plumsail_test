<template>
    <button type="button" class="buttons settings-button" @click="toggleSettingsShow" v-if="!showSettings">
    ...
    <div class="widget-headerSettings" v-if="showSettings">
        Settings
        <button type="button" class="buttons close-button" @click="toggleSettingsShow">
            &#10006;
        </button>
    </div>
</template>
